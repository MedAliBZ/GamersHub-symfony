 ...
 */
final class Version20220303145234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE teams ADD image LONGTEXT NOT NULL, CHANGE verified verified TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE teams DROP image, CHANGE team_name team_name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE verified verified TINYINT(1) DEFAULT NULL');
