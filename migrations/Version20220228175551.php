 ...
 */
final class Version20220228175551 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE teams CHANGE team_name team_name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE verified verified TINYINT(1) DEFAULT NULL');
