 ...
 */
final class Version20220214203959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name_product VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, quantity_stocked INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, creation_date DATE DEFAULT NULL, modification_date DATE DEFAULT NULL, is_enabled TINYINT(1) NOT NULL, INDEX IDX_B3BA5A5A12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
