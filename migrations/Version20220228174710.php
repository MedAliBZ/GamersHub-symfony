 ...
 */
final class Version20220228174710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE teams (id INT AUTO_INCREMENT NOT NULL, team_name VARCHAR(255) NOT NULL, gamers_nb INT NOT NULL, rank INT DEFAULT NULL, verified TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
