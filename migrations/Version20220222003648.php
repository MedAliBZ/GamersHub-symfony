 ...
 */
final class Version20220222003648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matchs CHANGE teams_id teams_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matchs CHANGE teams_id teams_id INT NOT NULL, CHANGE result result VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
