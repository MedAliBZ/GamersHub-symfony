 ...
 */
final class Version20220220192911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD oauth TINYINT(1) DEFAULT 0 NOT NULL, CHANGE password password VARCHAR(255) DEFAULT NULL');
    }
