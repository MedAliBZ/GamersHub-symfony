 ...
 */
final class Version20220301000746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sessioncoaching ADD text_color VARCHAR(7) NOT NULL');
    }
