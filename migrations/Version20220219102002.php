 ...
 */
final class Version20220219102002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sessioncoaching ADD background_color VARCHAR(7) NOT NULL, ADD border_color VARCHAR(7) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sessioncoaching DROP background_color, DROP border_color, CHANGE user_id user_id INT NOT NULL');
