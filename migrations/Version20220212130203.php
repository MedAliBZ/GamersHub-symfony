 ...
 */
final class Version20220212130203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coach (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, game_id_id INT NOT NULL, description VARCHAR(1000) NOT NULL, rating INT NOT NULL, UNIQUE INDEX UNIQ_3F596DCC9D86650F (user_id_id), INDEX IDX_3F596DCC4D77E7D8 (game_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
