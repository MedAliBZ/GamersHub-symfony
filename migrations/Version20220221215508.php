 ...
 */
final class Version20220221215508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE creation_date creation_date DATETIME DEFAULT NULL, CHANGE modification_date modification_date DATETIME DEFAULT NULL');
    }
