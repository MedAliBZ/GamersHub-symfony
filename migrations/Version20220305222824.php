 ...
 */
final class Version20220305222824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE missions_done CHANGE user_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE missions_done DROP FOREIGN KEY FK_ADF00AC0A76ED395');
        $this->addSql('ALTER TABLE missions_done CHANGE user_id user_id INT DEFAULT NULL');
